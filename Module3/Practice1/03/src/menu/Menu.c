...
void menu()
{
    ...
    if (stat(filename, &st) != -1) {
        deserializeList(contactList, filename);
        currentId = findMaxId(contactList);
    }
    ...
    while (flag) {
        ...
        switch(input){
            ...
            case 4:
                ...
                break;
            case 5:
                serializeList(contactList, "./file.dat");
                break;
            case 6:
                deserializeList(contactList, "./file.dat");
                break;
            default:
    ...
    serializeList(contactList, filename);
}
